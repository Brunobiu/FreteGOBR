...
export default function UsersListPage() {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex gap-2">
          {canManageAdmins && (
            <Link
              ...
              className="px-3 py-1.5 rounded text-sm bg-gray-800 text-gray-200 hover:bg-gray-700 transition"
            >
              Admins
            </Link>
          )}
          <button
            ...
            disabled={exporting}
            className="px-3 py-1.5 rounded text-sm bg-cyan-500/15 text-cyan-300 border border-cyan-500/30 hover:bg-cyan-500/25 disabled:opacity-50 transition"
          >
      ...
      <UsersFiltersUI filters={filters} onChange={applyFilters} totalFiltered={data?.total ?? 0} />
