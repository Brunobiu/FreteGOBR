    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-white">Meus Fretes</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-green-400">{fretesAtivos.length}</p>
            <p className="text-xs text-gray-400">Ativos</p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-gray-400">{fretesEncerrados.length}</p>
            <p className="text-xs text-gray-400">Encerrados/Cancelados</p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 text-center hidden md:block">
            <p className="text-2xl font-bold text-blue-400">
              {fretes.reduce((s, f) => s + f.viewsCount, 0)}
            </p>
            <p className="text-xs text-gray-400">Visualizações total</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-12 text-center">
            ...
            <p className="text-gray-400 mb-4">Comece publicando seu primeiro frete.</p>
            <button
              onClick={() => setIsFormOpen(true)}
      ...
      {isFormOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative bg-gray-900 rounded-lg max-w-4xl w-full border border-gray-800 shadow-xl p-6 max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-white">Postar Novo Frete</h2>
                <button
                  onClick={() => setIsFormOpen(false)}
