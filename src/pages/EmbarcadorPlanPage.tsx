      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          ...
          <div className="mt-4 flex items-center space-x-4">
            ...
            <span className="text-gray-400 text-sm">1/3 fretes usados este mês</span>
          </div>
        ...
        {/* Benefits Section */}
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold text-white mb-6">Por que fazer upgrade?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-white font-medium mb-1">Mais Visibilidade</h3>
              <p className="text-gray-400 text-sm">Seus fretes aparecem em destaque para mais motoristas</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-900/30 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-white font-medium mb-1">Analytics Detalhados</h3>
              <p className="text-gray-400 text-sm">Acompanhe visualizações e interesse nos seus fretes</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-900/30 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-white font-medium mb-1">Suporte Prioritário</h3>
              <p className="text-gray-400 text-sm">Atendimento rápido para resolver suas dúvidas</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-white font-medium mb-1">Emitem nota fiscal?</h3>
              <p className="text-gray-400 text-sm">
