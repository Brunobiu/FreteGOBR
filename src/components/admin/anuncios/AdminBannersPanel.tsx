...
/**
 * Painel admin para gerenciar Anúncios (banners do carrossel principal).
 * Extraido de AdminAnunciosPage.tsx para que a pagina possa ter tabs
 * (Anúncios / Categorias).
 */
    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <p className="text-sm text-gray-400">
          Banners exibidos no carrossel do motorista e embarcador.
        </p>
        <button
          onClick={openNew}
