...
- [ ] 1.1 Criar hook `useViewPreference` em `src/hooks/useViewPreference.ts`
  - Gerenciar estado de visualização (cards/table)
  - Persistir preferência no localStorage
  - Retornar [viewMode, setViewMode]
- [ ] 1.2 Criar hook `useIsMobile` em `src/hooks/useIsMobile.ts`
...
- [ ] 2.1 Criar `src/components/ViewToggle.tsx`
...
- [ ] 3.1 Criar `src/components/TablePagination.tsx`
...
- [ ] 4.1 Criar `src/components/FreteTableRow.tsx`
...
- [ ] 4.2 Criar `src/components/FreteTable.tsx`
...
- [ ] 6.1 Integrar hooks useViewPreference e useIsMobile
  - Chave localStorage: 'fretego-view-preference-embarcador'
  - Forçar cards quando isMobile
- [ ] 6.2 Adicionar ViewToggle no header
  - Ocultar quando isMobile
  - Posicionar ao lado do botão "Postar Frete"
- [ ] 6.3 Renderização condicional cards/tabela
  - FreteTable com showActions=true
  - Passar handlers onEdit e onDelete
- [ ] 6.4 Implementar estado e modal de edição
...
- [ ] 7.1 Adicionar props initialData e mode ao FreteForm
  - initialData?: Frete
  - mode?: 'create' | 'edit' (default: 'create')
- [ ] 7.2 Preencher campos com initialData quando mode='edit'
  - Usar useEffect para popular estado inicial
- [ ] 7.3 Ajustar texto do botão submit
  - 'create': "Publicar Frete"
  - 'edit': "Salvar Alterações"
- [ ] 7.4 Chamar updateFrete ao invés de createFrete quando mode='edit'

## Tarefa 8: Adicionar Filtros à EmbarcadorPage

- [ ] 8.1 Integrar FreteFilters na EmbarcadorPage
  - Posicionar acima da lista/tabela
  - Filtrar fretes localmente (já carregados)
- [ ] 8.2 Manter filtros ao alternar visualização
  - Estado de filtros no componente pai
  - Passar fretes filtrados para cards e tabela

## Tarefa 9: Testes e Validação

- [ ] 9.1 Testar alternância de visualização
